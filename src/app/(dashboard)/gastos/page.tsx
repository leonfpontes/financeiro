  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
      ...
      <Fab
        ...
        color="primary"
        onClick={openNew}
        sx={{ display: { xs: "flex", md: "none" }, position: "fixed", bottom: "calc(80px + env(safe-area-inset-bottom))", right: 16, zIndex: 1200 }}
      >
        <AddRoundedIcon />
      </Fab>
      ...
      <Drawer
        ...
        sx={{ zIndex: 1500 }}
        slotProps={{ paper: { sx: { width: { sm: 520 }, height: { xs: "92dvh", sm: "100%" }, borderRadius: { xs: "20px 20px 0 0", sm: 0 }, display: "flex", flexDirection: "column" } } }}
      >
